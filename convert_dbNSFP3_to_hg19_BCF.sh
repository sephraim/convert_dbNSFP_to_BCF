...
echo "- Creating index file for $SOURCE.bcf.gz..."
bcftools index --csi --force $SOURCE.bcf.gz
echo "   \--> Done! $SOURCE.bcf.gz.csi has been created"

echo "- Removing $SOURCE.vcf.gz..."
rm $SOURCE.vcf.gz
echo "   \--> Done! $SOURCE.vcf.gz has been removed"

echo "- Removing $SOURCE.vcf.gz.tbi..."
rm $SOURCE.vcf.gz.tbi
echo "   \--> Done! $SOURCE.vcf.gz.tbi has been removed"
